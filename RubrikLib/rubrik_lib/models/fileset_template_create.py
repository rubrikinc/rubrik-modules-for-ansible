...
class FilesetTemplateCreate(FilesetOptions):
    ...
    def __init__(self, allow_backup_network_mounts=None, allow_backup_hidden_folders_in_network_mounts=None, use_windows_vss=None, name=None, includes=None, excludes=None, exceptions=None, operating_system_type=None, share_type=None, pre_backup_script=None, post_backup_script=None, backup_script_timeout=None, backup_script_error_handling=None):
        super(FilesetTemplateCreate, self).__init__(allow_backup_network_mounts=allow_backup_network_mounts, allow_backup_hidden_folders_in_network_mounts=allow_backup_hidden_folders_in_network_mounts, use_windows_vss=use_windows_vss)
        self.name = name
