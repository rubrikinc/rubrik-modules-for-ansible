...
class ManagedVolumeSummaryListResponse(Model):
    """ManagedVolumeSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ManagedVolumeSummary
     <rubriklib_int.models.ManagedVolumeSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ManagedVolumeSummary]'},
