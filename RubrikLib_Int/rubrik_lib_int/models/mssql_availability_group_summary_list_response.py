...
class MssqlAvailabilityGroupSummaryListResponse(Model):
    ...
    :type data: list of :class:`MssqlAvailabilityGroupSummary
     <rubriklib_int.models.MssqlAvailabilityGroupSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[MssqlAvailabilityGroupSummary]'},
