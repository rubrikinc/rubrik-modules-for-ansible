...
class ArchivalLocationSummaryListResponse(Model):
    """ArchivalLocationSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ArchivalLocationSummary
     <rubriklib_int.models.ArchivalLocationSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ArchivalLocationSummary]'},
