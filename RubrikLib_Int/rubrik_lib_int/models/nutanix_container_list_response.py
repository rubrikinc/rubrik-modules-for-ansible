...
class NutanixContainerListResponse(Model):
    """NutanixContainerListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`NutanixContainer
     <rubriklib_int.models.NutanixContainer>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[NutanixContainer]'},
