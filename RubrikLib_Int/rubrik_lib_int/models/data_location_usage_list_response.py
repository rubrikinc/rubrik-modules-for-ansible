...
class DataLocationUsageListResponse(Model):
    """DataLocationUsageListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`DataLocationUsage
     <rubriklib_int.models.DataLocationUsage>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[DataLocationUsage]'},
