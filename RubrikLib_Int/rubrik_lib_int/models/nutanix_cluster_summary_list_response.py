...
class NutanixClusterSummaryListResponse(Model):
    """NutanixClusterSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`NutanixClusterSummary
     <rubriklib_int.models.NutanixClusterSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[NutanixClusterSummary]'},
