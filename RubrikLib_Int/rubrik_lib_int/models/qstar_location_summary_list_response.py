...
class QstarLocationSummaryListResponse(Model):
    """QstarLocationSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`QstarLocationSummary
     <rubriklib_int.models.QstarLocationSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[QstarLocationSummary]'},
