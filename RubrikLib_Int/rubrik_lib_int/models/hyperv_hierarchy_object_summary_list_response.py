...
class HypervHierarchyObjectSummaryListResponse(Model):
    """HypervHierarchyObjectSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`HypervHierarchyObjectSummary
     <rubriklib_int.models.HypervHierarchyObjectSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[HypervHierarchyObjectSummary]'},
