...
class AwsInstanceSummaryListResponse(Model):
    """AwsInstanceSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`AwsInstanceSummary
     <rubriklib_int.models.AwsInstanceSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[AwsInstanceSummary]'},
