...
class EventStatusSummaryListResponse(Model):
    """EventStatusSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`EventStatusSummary
     <rubriklib_int.models.EventStatusSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[EventStatusSummary]'},
