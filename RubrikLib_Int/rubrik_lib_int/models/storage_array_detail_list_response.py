...
class StorageArrayDetailListResponse(Model):
    """StorageArrayDetailListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`StorageArrayDetail
     <rubriklib_int.models.StorageArrayDetail>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[StorageArrayDetail]'},
