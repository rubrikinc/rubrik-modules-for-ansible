...
class KeyRotationDetailListResponse(Model):
    """KeyRotationDetailListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`KeyRotationDetail
     <rubriklib_int.models.KeyRotationDetail>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[KeyRotationDetail]'},
