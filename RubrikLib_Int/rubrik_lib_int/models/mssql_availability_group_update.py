...
class MssqlAvailabilityGroupUpdate(MssqlNonSlaProperties):
    ...
    def __init__(self, log_backup_frequency_in_seconds=None, log_retention_hours=None, copy_only=None, configured_sla_domain_id=None):
        super(MssqlAvailabilityGroupUpdate, self).__init__(log_backup_frequency_in_seconds=log_backup_frequency_in_seconds, log_retention_hours=log_retention_hours, copy_only=copy_only)
