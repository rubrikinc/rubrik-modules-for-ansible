...
class HypervHostSummaryListResponse(Model):
    """HypervHostSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`HypervHostSummary
     <rubriklib_int.models.HypervHostSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[HypervHostSummary]'},
