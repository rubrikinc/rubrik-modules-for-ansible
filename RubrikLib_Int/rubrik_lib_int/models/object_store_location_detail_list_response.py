...
class ObjectStoreLocationDetailListResponse(Model):
    """ObjectStoreLocationDetailListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ObjectStoreLocationDetail
     <rubriklib_int.models.ObjectStoreLocationDetail>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ObjectStoreLocationDetail]'},
