...
class SmtpInstanceDetailListResponse(Model):
    """SmtpInstanceDetailListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`SmtpInstanceDetail
     <rubriklib_int.models.SmtpInstanceDetail>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[SmtpInstanceDetail]'},
