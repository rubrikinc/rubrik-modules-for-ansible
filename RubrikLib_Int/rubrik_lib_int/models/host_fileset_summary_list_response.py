...
class HostFilesetSummaryListResponse(Model):
    """HostFilesetSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`HostFilesetSummary
     <rubriklib_int.models.HostFilesetSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[HostFilesetSummary]'},
