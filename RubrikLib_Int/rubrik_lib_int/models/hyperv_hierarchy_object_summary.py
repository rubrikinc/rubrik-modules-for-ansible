...
class HypervHierarchyObjectSummary(ManagedHierarchyObjectSummary):
    ...
    :param connection_status: Connection status of hyperv host. This is
     defined only for hyperv host. Possible values include: 'Connected',
     'Connecting', 'Disconnected'
    :type connection_status: str or :class:`enum <rubriklib_int.models.enum>`
    :param descendent_count:
    :type descendent_count: :class:`HypervHierarchyObjectDescendentCount
     <rubriklib_int.models.HypervHierarchyObjectDescendentCount>`
    """
