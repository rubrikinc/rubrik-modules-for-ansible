...
class ManagedVolumeSnapshotSummaryListResponse(Model):
    """ManagedVolumeSnapshotSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ManagedVolumeSnapshotSummary
     <rubriklib_int.models.ManagedVolumeSnapshotSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ManagedVolumeSnapshotSummary]'},
