...
class HostShareCredentialDetailListResponse(Model):
    """HostShareCredentialDetailListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`HostShareCredentialDetail
     <rubriklib_int.models.HostShareCredentialDetail>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[HostShareCredentialDetail]'},
