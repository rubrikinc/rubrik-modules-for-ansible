...
class NfsLocationDetailListResponse(Model):
    """NfsLocationDetailListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`NfsLocationDetail
     <rubriklib_int.models.NfsLocationDetail>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[NfsLocationDetail]'},
