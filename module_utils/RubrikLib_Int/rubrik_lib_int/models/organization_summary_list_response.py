...
class OrganizationSummaryListResponse(Model):
    """OrganizationSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`OrganizationSummary
     <rubriklib_int.models.OrganizationSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[OrganizationSummary]'},
