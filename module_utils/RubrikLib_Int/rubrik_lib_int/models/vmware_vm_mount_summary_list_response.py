...
class VmwareVmMountSummaryListResponse(Model):
    """VmwareVmMountSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`VmwareVmMountSummary
     <rubriklib_int.models.VmwareVmMountSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[VmwareVmMountSummary]'},
