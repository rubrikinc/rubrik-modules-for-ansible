...
class ArchivalLocationConnectJobListResponse(Model):
    """ArchivalLocationConnectJobListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ArchivalLocationConnectJob
     <rubriklib_int.models.ArchivalLocationConnectJob>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ArchivalLocationConnectJob]'},
