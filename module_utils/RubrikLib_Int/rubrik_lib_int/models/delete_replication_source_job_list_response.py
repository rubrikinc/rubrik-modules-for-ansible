...
class DeleteReplicationSourceJobListResponse(Model):
    """DeleteReplicationSourceJobListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`DeleteReplicationSourceJob
     <rubriklib_int.models.DeleteReplicationSourceJob>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[DeleteReplicationSourceJob]'},
