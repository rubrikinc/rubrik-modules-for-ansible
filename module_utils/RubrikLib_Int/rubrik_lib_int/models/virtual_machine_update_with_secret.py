...
class VirtualMachineUpdateWithSecret(VirtualMachineUpdate):
    ...
    :type pre_backup_script: :class:`VirtualMachineScriptDetail
     <rubriklib_int.models.VirtualMachineScriptDetail>`
    ...
    :type cloud_instantiation_spec: :class:`CloudInstantiationSpec
     <rubriklib_int.models.CloudInstantiationSpec>`
    :param guest_credential:
    :type guest_credential: :class:`BaseGuestCredential
     <rubriklib_int.models.BaseGuestCredential>`
    """
    ...
    def __init__(self, max_nested_vsphere_snapshots=None, snapshot_consistency_mandate=None, is_vm_paused=None, configured_sla_domain_id=None, pre_backup_script=None, post_snap_script=None, post_backup_script=None, is_array_integration_enabled=None, cloud_instantiation_spec=None, guest_credential=None):
        super(VirtualMachineUpdateWithSecret, self).__init__(max_nested_vsphere_snapshots=max_nested_vsphere_snapshots, snapshot_consistency_mandate=snapshot_consistency_mandate, is_vm_paused=is_vm_paused, configured_sla_domain_id=configured_sla_domain_id, pre_backup_script=pre_backup_script, post_snap_script=post_snap_script, post_backup_script=post_backup_script, is_array_integration_enabled=is_array_integration_enabled, cloud_instantiation_spec=cloud_instantiation_spec)
