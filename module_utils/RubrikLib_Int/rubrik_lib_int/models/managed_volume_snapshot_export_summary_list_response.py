...
class ManagedVolumeSnapshotExportSummaryListResponse(Model):
    """ManagedVolumeSnapshotExportSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ManagedVolumeSnapshotExportSummary
     <rubriklib_int.models.ManagedVolumeSnapshotExportSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ManagedVolumeSnapshotExportSummary]'},
