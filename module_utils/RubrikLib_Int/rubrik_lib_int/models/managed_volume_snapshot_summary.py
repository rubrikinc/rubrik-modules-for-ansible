...
class ManagedVolumeSnapshotSummary(BaseSnapshotSummary):
    ...
    _attribute_map = {
        ...
        'links': {'key': 'links', 'type': 'ManagedVolumeSnapshotLinks'},
    }
