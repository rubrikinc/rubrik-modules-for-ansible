...
class HypervClusterSummaryListResponse(Model):
    """HypervClusterSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`HypervClusterSummary
     <rubriklib_int.models.HypervClusterSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[HypervClusterSummary]'},
