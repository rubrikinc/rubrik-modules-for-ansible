...
class AdminAuthorizationListResponse(Model):
    """AdminAuthorizationListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`AdminAuthorization
     <rubriklib_int.models.AdminAuthorization>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[AdminAuthorization]'},
