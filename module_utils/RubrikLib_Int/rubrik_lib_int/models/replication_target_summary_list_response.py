...
class ReplicationTargetSummaryListResponse(Model):
    """ReplicationTargetSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ReplicationTargetSummary
     <rubriklib_int.models.ReplicationTargetSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ReplicationTargetSummary]'},
