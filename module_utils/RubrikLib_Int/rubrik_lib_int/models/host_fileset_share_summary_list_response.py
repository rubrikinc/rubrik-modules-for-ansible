...
class HostFilesetShareSummaryListResponse(Model):
    """HostFilesetShareSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`HostFilesetShareSummary
     <rubriklib_int.models.HostFilesetShareSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[HostFilesetShareSummary]'},
