...
class UnmanagedSnapshotSummaryListResponse(Model):
    """UnmanagedSnapshotSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`UnmanagedSnapshotSummary
     <rubriklib_int.models.UnmanagedSnapshotSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[UnmanagedSnapshotSummary]'},
