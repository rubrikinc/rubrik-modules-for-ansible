...
class EndUserAuthorizationListResponse(Model):
    """EndUserAuthorizationListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`EndUserAuthorization
     <rubriklib_int.models.EndUserAuthorization>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[EndUserAuthorization]'},
