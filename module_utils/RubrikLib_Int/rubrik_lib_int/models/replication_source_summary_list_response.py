...
class ReplicationSourceSummaryListResponse(Model):
    """ReplicationSourceSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ReplicationSourceSummary
     <rubriklib_int.models.ReplicationSourceSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ReplicationSourceSummary]'},
