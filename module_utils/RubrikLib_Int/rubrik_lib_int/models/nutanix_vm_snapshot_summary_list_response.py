...
class NutanixVmSnapshotSummaryListResponse(Model):
    """NutanixVmSnapshotSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`NutanixVmSnapshotSummary
     <rubriklib_int.models.NutanixVmSnapshotSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[NutanixVmSnapshotSummary]'},
