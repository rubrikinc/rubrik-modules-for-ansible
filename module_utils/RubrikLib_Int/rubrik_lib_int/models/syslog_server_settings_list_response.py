...
class SyslogServerSettingsListResponse(Model):
    """SyslogServerSettingsListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`SyslogServerSettings
     <rubriklib_int.models.SyslogServerSettings>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[SyslogServerSettings]'},
