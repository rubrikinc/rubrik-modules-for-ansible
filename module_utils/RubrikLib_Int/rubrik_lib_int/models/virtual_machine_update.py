...
class VirtualMachineUpdate(Model):
    ...
    def __init__(self, max_nested_vsphere_snapshots=None, snapshot_consistency_mandate=None, is_vm_paused=None, configured_sla_domain_id=None, pre_backup_script=None, post_snap_script=None, post_backup_script=None, is_array_integration_enabled=None, cloud_instantiation_spec=None):
