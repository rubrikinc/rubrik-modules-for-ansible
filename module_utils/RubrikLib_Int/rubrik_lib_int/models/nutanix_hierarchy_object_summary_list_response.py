...
class NutanixHierarchyObjectSummaryListResponse(Model):
    """NutanixHierarchyObjectSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`NutanixHierarchyObjectSummary
     <rubriklib_int.models.NutanixHierarchyObjectSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[NutanixHierarchyObjectSummary]'},
