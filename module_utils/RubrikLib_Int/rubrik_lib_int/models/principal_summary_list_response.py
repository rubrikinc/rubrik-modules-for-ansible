...
class PrincipalSummaryListResponse(Model):
    """PrincipalSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`PrincipalSummary
     <rubriklib_int.models.PrincipalSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[PrincipalSummary]'},
