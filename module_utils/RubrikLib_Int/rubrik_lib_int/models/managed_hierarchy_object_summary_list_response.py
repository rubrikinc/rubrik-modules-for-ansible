...
class ManagedHierarchyObjectSummaryListResponse(Model):
    """ManagedHierarchyObjectSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ManagedHierarchyObjectSummary
     <rubriklib_int.models.ManagedHierarchyObjectSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ManagedHierarchyObjectSummary]'},
