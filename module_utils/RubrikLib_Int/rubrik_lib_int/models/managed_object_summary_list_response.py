...
class ManagedObjectSummaryListResponse(Model):
    """ManagedObjectSummaryListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`ManagedObjectSummary
     <rubriklib_int.models.ManagedObjectSummary>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[ManagedObjectSummary]'},
