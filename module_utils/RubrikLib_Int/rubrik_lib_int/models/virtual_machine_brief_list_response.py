...
class VirtualMachineBriefListResponse(Model):
    """VirtualMachineBriefListResponse.

    :param has_more: If there is more
    :type has_more: bool
    :param data: List of matching objects
    :type data: list of :class:`VirtualMachineBrief
     <rubriklib_int.models.VirtualMachineBrief>`
    ...
    _attribute_map = {
        ...
        'data': {'key': 'data', 'type': '[VirtualMachineBrief]'},
