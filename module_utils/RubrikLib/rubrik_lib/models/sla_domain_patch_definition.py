...
class SlaDomainPatchDefinition(Model):
    ...
    def __init__(self, name=None, frequencies=None, allowed_backup_windows=None, first_full_allowed_backup_windows=None, local_retention_limit=None, archival_specs=None, replication_specs=None):
        self.name = name
