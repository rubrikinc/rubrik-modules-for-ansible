...
def main():
    ...
    argument_spec = dict(
        vm_id=dict(required=False, type='str',default=None),
        vm_name=dict(required=False, type='str', default=None),
    )
    ...
    try:
        api_request = rubrik.register_agent(ansible["vm_name"],ansible["vm_id"])
    except SystemExit as error:
        module.fail_json(msg=str(error))
    #fixed
