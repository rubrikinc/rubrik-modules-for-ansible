...
import library.rubrik_nas_fileset as rubrik_nas_fileset
...
class TestRubrikNASFileset(unittest.TestCase):
    ...
    def test_module_fail_when_required_args_missing(self):
        with self.assertRaises(AnsibleFailJson):
            set_module_args({})
            rubrik_nas_fileset.main()

    @patch.object(rubrik_nas_fileset.rubrik_cdm.rubrik_cdm.Connect, 'post', autospec=True, spec_set=True)
    @patch.object(rubrik_nas_fileset.rubrik_cdm.rubrik_cdm.Connect, 'get', autospec=True, spec_set=True)
    def test_module_configure_rubrik_nas_fileset(self, mock_get, mock_post):
