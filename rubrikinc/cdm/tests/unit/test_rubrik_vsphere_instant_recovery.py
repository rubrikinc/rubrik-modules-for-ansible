...
import ansible_collections.rubrikinc.cdm.plugins.modules.rubrik_vsphere_instant_recovery as rubrik_vsphere_instant_recovery
...
class TestRubrikVsphereInstantRecovery(unittest.TestCase):
    ...
    @patch.object(rubrik_vsphere_instant_recovery.rubrik_cdm.rubrik_cdm.Connect, 'post', autospec=True, spec_set=True)
    @patch.object(rubrik_vsphere_instant_recovery.rubrik_cdm.rubrik_cdm.Connect, 'get', autospec=True, spec_set=True)
    def test_module_configure_rubrik_vsphere_instant_recovery(self, mock_get, mock_post):
        ...
        self.assertEqual(result.exception.args[0]['response'], mock_post_v1_vmware_vm_snapshot_id_instant_recover())

    @patch.object(rubrik_vsphere_instant_recovery.rubrik_cdm.rubrik_cdm.Connect, 'post', autospec=True, spec_set=True)
    @patch.object(rubrik_vsphere_instant_recovery.rubrik_cdm.rubrik_cdm.Connect,
    ...
    @patch.object(rubrik_vsphere_instant_recovery.rubrik_cdm.rubrik_cdm.Connect,
                  '_date_time_conversion', autospec=True, spec_set=True)
    @patch.object(rubrik_vsphere_instant_recovery.rubrik_cdm.rubrik_cdm.Connect, 'get', autospec=True, spec_set=True)
    def test_module_configure_rubrik_vsphere_instant_recovery_specific_host(
